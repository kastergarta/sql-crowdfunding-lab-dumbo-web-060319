...
"SELECT projects.title, (projects.funding_goal - SUM(pledges.amount)) FROM projects INNER JOIN pledjes ON projects.id = pledges.project_id GROUP BY projects.title"
end
